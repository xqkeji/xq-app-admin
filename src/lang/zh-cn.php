...
return [
	...
	//系统配置和更新静态文件
	'admin config update_config title'=>'系统配置',
	'admin config update_config success'=>'更新配置信息成功',
	'admin config update_statics title'=>'更新静态文件',
	'admin config update_statics success'=>'静态文件(js、css等)更新成功',
	//系统配置和更新静态文件权限
	...
	//管理员管理
	'admin user admin title'=>'管理员管理',
	'admin user add title'=>'添加管理员',
	'admin user edit title'=>'编辑管理员',
	'add admin user success'=>'添加管理员成功',
	'add admin user failed'=>'添加管理员失败',
	'edit admin user success'=>'编辑管理员成功',
	'edit admin user failed'=>'编辑管理员失败',
	'delete admin user success'=>'删除管理员成功',
	'delete admin user failed'=>'删除管理员失败',
	//管理员管理权限
	...
	//角色管理
	'admin user_role admin title'=>'角色管理',
	'admin user_role add title'=>'添加角色',
	'admin user_role edit title'=>'编辑角色',
	'add admin user_role success'=>'添加角色成功',
	'add admin user_role failed'=>'添加角色失败',
	'edit admin user_role success'=>'编辑角色成功',
	'edit admin user_role failed'=>'编辑角色失败',
	'delete admin user_role success'=>'删除角色成功',
	'delete admin user_role failed'=>'删除角色失败',
	//角色权限
